        ...
        execute: function() {
            WeatherService = (function () {
                function WeatherService(_http) {
                    this._http = _http;
                    this.API_BASE_URL = window.location.href + 'city/';
                }
                ...
                WeatherService.prototype.getLocation = function (city) {
                    return this._http.get(this.API_BASE_URL + city)
                        .map(function (res) { return res.json().city.name + ', ' + res.json().city.country; });
                };
